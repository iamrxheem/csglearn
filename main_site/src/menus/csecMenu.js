...
class CSECMenu extends React.Component {
  constructor(props) {
    super(props)
        ...
        >
          ...
          <Collapse open={this.state.collapseOpen} navbar>
            ...
            >
              {/* Subjects */}
              <NavItem>
                <Link className="nav-link" to="/programmes/csec/subjects">
                  Subjects
                </Link>
              </NavItem>
              ...
              {/* Tuition */}
              <NavItem>
                <Link className="nav-link" to="/programmes/csec/tuition">
                  Tuition
                </Link>
              </NavItem>
              ...
              {/* Syllabus */}
              <NavItem>
                <Link className="nav-link" to="/programmes/csec/syllabus">
                  Syllabus
                </Link>
              </NavItem>
              ...
              {/* FAQs */}
              <NavItem className="d-none d-md-block">
                <Link className="nav-link" to="/programmes/csec/faqs">
...
CSECMenu.defaultProps = {
  siteTitle: ``
}

export default CSECMenu
