...
const Page = () => (
  ...
  >
    <Container>
      ...
      <Form
        action="https://forms.zohopublic.com/csglearninginstitute/form/DiplomainFrenchRegistrationForm/formperma/7LKz5bXmcfhTBbPpMrCoxYfRqEAhpIyq5AKB6Ba7eNk/htmlRecords/submit"
        name="form"
        id="form"
        method="POST"
        acceptCharset="UTF-8"
      ...
      >
        ...
        <h2>Diploma in French Registration Form</h2>
        ...
        <Row>
          ...
          <Col md={6}>
            <FormGroup>
              <label>
                Please select Diploma in French (DELF) diploma level
                <em className="text-danger ml-1">*</em>
              </label>
          ...
          <Col md={6}>
            ...
            <FormGroup>
              <Button target="_blank" style={{ width: "100%" }} type="submit">
                Submit
              </Button>
            </FormGroup>
          </Col>
