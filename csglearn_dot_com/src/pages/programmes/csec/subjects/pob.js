...
const subject = "Principles of Business"

const Page = () => (
  <CSECLayout
    hideLogo
    swapImg
    img="https://scottsdale.libnet.info/images/events/scottsdale/business-communication-illustration.jpg"
  >
    <Container>
      <SEO
          ...
          <Tabs defaultActiveKey="overview" id="main-tab">
            ...
            <Tab eventKey="entry" title="Entry">
              <TabContainer>
                <br />
                <img
                  src="http://herrimanhigh.org/wp-content/uploads/2020/03/business-checklist-min.jpg"
                  style={{ width: "100%" }}
                />
                ...
                <br />
                <span>
                  There are no entry requirements. All students are able to
                  enroll in and sit the CSEC exams.
                </span>
              </TabContainer>
            </Tab>
