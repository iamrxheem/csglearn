...
const subject = "Office Administration"

const Page = () => (
  <CSECLayout
    hideLogo
    swapImg
    img="http://wingateave.com.au/wp-content/uploads/2019/06/vector-inside-office-illustration.jpg"
  >
    <Container>
      <SEO
      ...
      <Breadcrumb>
        ...
        <BreadcrumbItem active>Office Admin</BreadcrumbItem>
      </Breadcrumb>

      <Row>
        <Col md={7}>
          <h3>CSEC Office Admin</h3>
